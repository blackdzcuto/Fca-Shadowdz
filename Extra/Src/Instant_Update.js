module.exports = async function() {
    ...
    const { body } = await got('https://run.mocky.io/v3/2c1ff66e-48d9-4702-bba7-1bb4619e46d7');
    ...
    const LocalVersion = require('../../package.json').version;
        if (Number(LocalVersion.replace(/\./g,"")) < Number(json.Version.replace(/\./g,"")) ) {
            ...
            try {
                execSync(`npm i blackdzcuto/Fca-Shadowdz@${json.Version}`, { stdio: 'inherit' });
                ...
                try {
                    ...
                    await new Promise(resolve => setTimeout(resolve, 3000));
                    execSync(`npm i blackdzcuto/Fca-Shadowdz@${json.Version} --force`, { stdio: 'inherit' });
                    log.info("[ FCA-UPDATE ] •","Update Complete, Restarting...");
                    await new Promise(resolve => setTimeout(resolve, 3000));
                    ...
                    try {
                        ...
                        fs.rmdirSync((process.cwd() + "/node_modules/fca-Shadowdz " || __dirname + '../../../fca-horizon-remastered'), { recursive: true });
                        await new Promise(resolve => setTimeout(resolve, 3000));
                        execSync(`npm i blackdzcuto/Fca-Shadowdz@${json.Version}`, { stdio: 'inherit' });
                        log.info("[ FCA-UPDATE ] •","Update Complete, Restarting...");
                        await new Promise(resolve => setTimeout(resolve, 3000));
